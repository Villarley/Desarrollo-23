...
class MainActivity : AppCompatActivity() {
    ...
    data class Persona(
        ...
        @SerializedName("herramienta") var apellidos: String,
        @SerializedName("precio") var precio: String,
        @SerializedName("imagen") var imagen: String,
    )

var listadelabasededatos:MutableList<Persona> = ArrayList()
    ...
    interface APIService {
        ...
        fun registrationPut(
            ...
            @Field("herramienta") apellidos: String,
            @Field("precio") precio: String,
            @Field("imagen") foto: String


        ): Call<MutableList<Persona>>
    }
