...
class adapter   : RecyclerView.Adapter<adapter.ViewHolder>()  {
    ...
    var Lugares:MutableList<MainActivity.User> = ArrayList()

    lateinit var context: Context

    fun adapter(lugares: MutableList<MainActivity.User>, context: Context){
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(lugar: MainActivity.User, context: Context){
            NOMBRE.text = lugar.NOMBRE
            PROVINCIA.text =  lugar.APELLIDO
            if(lugar.FOTO != "") {
                try {
